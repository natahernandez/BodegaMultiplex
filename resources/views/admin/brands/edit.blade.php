    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Editar Marca</h1>
                <p class="page-header-text">Modifica la información de la marca "{{ $brand->nombre }}"</p>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('brands.update', $brand) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Form -->
                        <div class="row mb-4">
                            <label for="nombre" class="col-sm-3 col-form-label form-label">Nombre <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Nombre de la marca"></i></label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" placeholder="Ej: Nike, Adidas, Samsung..." value="{{ old('nombre', $brand->nombre) }}" required>
                                @error('nombre')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion" placeholder="Descripción de la marca..." rows="4">{{ old('descripcion', $brand->descripcion) }}</textarea>
                                @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- Form -->
                        <div class="row mb-4">
                            <label class="col-sm-3 col-form-label form-label">Logo/Imagen</label>

                            <div class="col-sm-9">
                                @if($brand->imagen_url)
                                    <div class="mb-3">
                                        <img src="{{ $brand->imagen_url }}" alt="{{ $brand->nombre }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1" {{ old('activo', $brand->activo) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="activo">Marca activa</label>
                                </div>
                                <!-- End Form Switch -->
                                <small class="form-text text-muted">Las marcas inactivas no se mostrarán en los formularios de productos.</small>
                            </div>
                        </div>
                        <!-- End Form -->
                        ...
                        <div class="js-sticky-block card" data-hs-sticky-block-options='{
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-end gap-3">
                                    <a class="btn btn-white" href="{{ route('brands.index') }}">Cancelar</a>
