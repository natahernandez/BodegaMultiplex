...
<head>
    ...
    <title>Comprobante de Pago - {{ $order->numero_orden }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="payment-section">
        ...
        <div class="payment-details">
            ...
            <div class="payment-right">
                @if(isset($order->info_pago['ultimos_digitos']))
                <div class="info-row">
                    <span class="info-label">Tarjeta:</span>
                    **** **** **** {{ $order->info_pago['ultimos_digitos'] }}
                </div>
                @endif
                <div class="info-row">
        ...
        <div class="transaction-box">
            <div class="text-center">
                <strong>ID de Transacción: {{ strtoupper(md5($order->numero_orden . $order->created_at)) }}</strong>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <p><strong>Este comprobante confirma que su pago ha sido procesado exitosamente</strong></p>
        <p>Conserve este documento como comprobante de su transacción</p>
    </div>
</body>
</html> 